...
// admin
export const ADMIN_ADD = "/admin/clothes/add";
export const ADMIN_EDIT = "/admin/clothes/edit";
export const ADMIN_DELETE = "/admin/clothes/delete";
...
// clothes
export const CLOTHES_IDS = "/clothes/ids";
export const CLOTH_SEARCH = "/clothes/search";
export const CLOTH_SEARCH_TEXT = "/clothes/search/text";
export const CLOTHES_GRAPHQL_CLOTH = "/clothes/graphql/cloth";
export const CLOTHES_GRAPHQL_CLOTHES = "/clothes/graphql/clothes";
export const CLOTHES_GRAPHQL_IDS = "/clothes/graphql/ids";
